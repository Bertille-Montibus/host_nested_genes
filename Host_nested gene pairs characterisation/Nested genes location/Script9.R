...
#Normalisation to the expected number of nested gene per intron according to the number of nested genes and the number of introns
count_intron_number$expected_per_intron = count_intron_number$n / count_intron_number$exon_intron_total_number
count_intron_number_location_normalised = merge.data.frame(count_intron_number_location, count_intron_number[,c(1,3)], by.x = 2, by.y = 1, all.x = T)
count_intron_number_location_normalised$Observed_expected = count_intron_number_location_normalised$n / count_intron_number_location_normalised$expected_per_intron
count_intron_number_location_normalised_graph = count_intron_number_location_normalised[count_intron_number_location_normalised$exon_intron_total_number>1 & count_intron_number_location_normalised$exon_intron_total_number<= 20,]
count_intron_number_location_normalised_graph$exon_intron_number = as.factor(count_intron_number_location_normalised_graph$exon_intron_number)
count_intron_number_location_normalised_graph$exon_intron_total_number = as.factor(count_intron_number_location_normalised_graph$exon_intron_total_number)

ggplot(count_intron_number_location_normalised_graph, aes(fill=exon_intron_number, y= log(Observed_expected), x=exon_intron_total_number)) +
  geom_bar(position = "dodge", stat = "identity")+
  scale_fill_viridis(discrete = T, option = "C", direction = -1)
